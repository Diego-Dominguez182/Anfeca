...
class LocationPropertieScreen extends StatefulWidget {
  const LocationPropertieScreen({Key? key}) : super(key: key);
...
Widget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      ...
      onTapRigthText: () {
        Navigator.pushNamed(context, AppRoutes.propertyServicesScreen);
      },
    );
  }
...
Widget _buildMaps(BuildContext context) {
  return GoogleMap(
    ...
    onCameraMove: (CameraPosition position) {
      _markers.removeWhere((marker) => marker.markerId.value == 'center_location');
